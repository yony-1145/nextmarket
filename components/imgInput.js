...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try{
            ...
            data.append("upload_preset", "yy1234cl")
            data.append("cloud_name","db7kilnu3")
            const response= await fetch("https://api.cloudinary.com/v1_1/db7kilnu3/image/upload", {method: "POST", body: data})
